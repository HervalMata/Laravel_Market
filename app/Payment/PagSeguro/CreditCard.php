...
class CreditCard
{
    ...
    public function doPayment()
    {
        ...
        $creditCard->setSender()->setDocument()->withParameters('CPF', '27121238918');
        ...
        $creditCard->setHolder()->setName($this->cardInfo['cardName']);
        $creditCard->setHolder()->setPhone()->withParameters(11, 56273440);
        $creditCard->setHolder()->setDocument()->withParameters('CPF', '27121238918');
        $creditCard->setMode('DRFAULT');
