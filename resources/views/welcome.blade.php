...
<section class="section-intro padding-y-sm">
    <div class="container">
        ...
        <div class="intro-banner-wrap">
            <img src="{{ asset('lib/bootstrap-ecommerce-uikit/ui-ecommerce/images/banners/banner-request.jpg') }}" class="img-fluid rounded">
        </div>
    ...
    <div class="container">
        <article class="card card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <figure  class="item-feature">
                        <span class="text-primary"><i class="far fa-2x fa-landmark"></i></span>
                        <figcaption class="pt-3">
                            <h5 class="title">Criatividade</h5>
...
<section class="section-content">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div href="{{route('product.single', ['slug' => $product->slug])}}" class="card card-product-grid" >
                    @if ($product->photos->count())
                        <a href="#" class="img-wrap"> <img src="{{ asset('storage/' . $product->photos->first()->image) }}"> </a>
                    @else
                        <a href="#" class="img-wrap"> <img src="{{ asset('lib/bootstrap-ecommerce-uikit/ui-ecommerce/images/imagem-produto.png') }}"> </a>
                    @endif
                    <figcaption class="info-wrap">
                        <a href="{{route('product.single', ['slug' => $product->slug])}}" class="title">{{$product->name}}</a>
                        ...
                        <div class="price mt-1">R${{number_format($product->price, 2, ',', '.')}}</div> <!-- price-wrap.// -->
...
<section class="section-name padding-y">
    <div class="container">
        ...
        <h3 class="mb-3">Download nosso app</h3>
